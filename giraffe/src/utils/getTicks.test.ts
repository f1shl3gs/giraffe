...
describe('utils/getTicks', () => {
  ...
  describe('calculateTicks', () => {
    describe('time ticks', () => {
      ...
      it('should handle 4 to 10 time ticks', () => {
        ...
        let tickSize = 116
        let result = [
          1586383800000, 1586384100000, 1586384400000, 1586384700000,
        ]
        expect(
          calculateTicks(timeDomain, rangeLength, tickSize, columnKey)
        ).toEqual(result)
        ...
        tickSize = 62
        result = [
          1586384640000, 1586384700000, 1586384760000, 1586384820000,
          1586384880000, 1586384940000, 1586385000000, 1586385060000,
          1586385120000,
        ]
        expect(
          calculateTicks(timeDomain, rangeLength, tickSize, columnKey)
      ...
      it('should handle more than 10 ticks', () => {
        ...
        const tickSize = 39
        const result = [
          1586384700000, 1586384760000, 1586384820000, 1586384880000,
          1586384940000, 1586385000000, 1586385060000, 1586385120000,
          1586385180000, 1586385240000, 1586385300000, 1586385360000,
          1586385420000, 1586385480000, 1586385540000, 1586385600000,
          1586385660000, 1586385720000, 1586385780000,
        ]
        expect(
          calculateTicks(timeDomain, rangeLength, tickSize, columnKey)
        ).toEqual(result)
  ...
  describe('horizontal axis', () => {
    ...
    const result = [
      1578355950000, 1578355980000, 1578356010000, 1578356040000, 1578356070000,
      1578356100000, 1578356130000, 1578356160000, 1578356190000, 1578356220000,
      1578356250000, 1578356280000, 1578356310000, 1578356340000, 1578356370000,
      1578356400000, 1578356430000, 1578356460000, 1578356490000, 1578356520000,
      1578356550000, 1578356580000, 1578356610000, 1578356640000, 1578356670000,
      1578356700000, 1578356730000, 1578356760000, 1578356790000, 1578356820000,
      1578356850000, 1578356880000, 1578356910000, 1578356940000, 1578356970000,
      1578357000000, 1578357030000, 1578357060000,
    ]
    it('should give the correct number of ticks', () => {
