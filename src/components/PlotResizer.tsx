import {FunctionComponent, ReactElement, RefObject, useMemo} from 'react'
...
export const PlotResizer: FunctionComponent<PlotResizerProps> = props => {
...
export const TableResizer: FunctionComponent<TableResizerProps> = props => {
