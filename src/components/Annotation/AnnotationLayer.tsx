...
// Constants
import {ANNOTATION_DEFAULT_HOVER_MARGIN} from 'constants'
...
export const AnnotationLayer: FunctionComponent<
  AnnotationLayerProps
> = props => {
  const {config, spec, width, height, hoverX, hoverY, xScale, yScale, onHover} =
    props
