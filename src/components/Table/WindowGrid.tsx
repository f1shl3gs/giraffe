...
interface WindowGridProps {
  cellRenderer: (args: WindowGridCellArgs) => ReactElement
  className?: string
  columnCount: number
...
export const WindowGrid: FunctionComponent<WindowGridProps> = props => {
  const {
    cellRenderer,
    className,
    columnCount,
      ...
      cells.push(
        cellRenderer({
          ...
          style: {
            ...
            left:
              getItemOffset(columnWidth, columnCount, columnIndex) - scrollLeft,
            position: 'absolute',
